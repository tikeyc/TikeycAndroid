...
public class TStretchableListView extends RecyclerView {

    public TStretchableListView(Context context) {
        super(context);
    }

    public TStretchableListView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public TStretchableListView(Context context, @Nullable AttributeSet attrs, int defStyle) {
    ...
    private int offset_Y = 0;//记录滑动的距离
...
//                Log.e("TAG","recyclerView.getScrollY():" + recyclerView.getScrollY() + " " + "dx:" + dx + " " + "dy:" + dy);
//                Log.e("TAG","getScollYDistance:" + getScollYDistance());
                offset_Y -= dy;
                Log.e("TAG","offset_Y:" + offset_Y);
            }
        });
    }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        if (offset_Y != 0) return super.onTouchEvent(ev);
